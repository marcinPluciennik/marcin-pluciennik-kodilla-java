...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://marcinpluciennik.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("marcinpluciennik76@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("23futrako");
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        driver.switchTo().alert().accept(); //zamykanie okienka alertu po wysłaniu karty do trello
